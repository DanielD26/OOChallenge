    ...
    public class UI
    {
        ...
        public void TopMenu() {
            ...
            switch(input) {
                ...
                case "5":
                    ...
                    int totalC2;
                    int totalC3;
                    totalC1= Courses[0].Enrolments.Count();
                    totalC2= Courses[1].Enrolments.Count();
                    totalC3= Courses[2].Enrolments.Count();
                    System.Console.WriteLine(totalC1 + totalC2 + totalC3);
                    break;
        ...
        private string GetStudentName(int num)
        {
            ...
            for (int i = 0; i < Students.Count; i++) {
                if (num == Students[i].StudentNo) {
                   return Students[i].GetFullName();
                }
            }
        ...
        private int CourseGetNumStudents(int num)
        {
            ...
            if (num == Courses[0].CourseNo) {
                return (Courses[0].Enrolments.Count);
            } else if (num == Courses[1].CourseNo) {
                return (Courses[1].Enrolments.Count);
            } else if (num == Courses[2].CourseNo) {
                return (Courses[2].Enrolments.Count);
            }
                return -1;
        }
